...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : TOUCH_DOUT_Pin KEY_PAGE_Pin KEY_CONFIRM_Pin KEY_BACK_Pin */
  GPIO_InitStruct.Pin = TOUCH_DOUT_Pin|KEY_PAGE_Pin|KEY_CONFIRM_Pin|KEY_BACK_Pin;
